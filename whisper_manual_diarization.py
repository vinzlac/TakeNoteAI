#!/usr/bin/env python3
"""
Script de transcription avec identification manuelle des locuteurs
Permet de corriger manuellement les assignations de locuteurs
"""
...
class ManualSpeakerDiarization:
    """Classe pour transcription avec correction manuelle des locuteurs."""
    ...
    def assign_speakers_manually(self, segments: List[Dict]) -> List[Dict]:
        """
        Assignation manuelle des locuteurs basée sur des règles simples.
        ...
        """
        print("🎤 Assignation manuelle des locuteurs...")
        ...
        for i, segment in enumerate(segments):
            ...
            # Règles simples pour l'assignation
            ...
            # 2. Réponses courtes typiques
                  ...
                  any(word in text.lower() for word in ["oui", "non", "ok", "d'accord", "exactement", "précisément"])):
                speaker_changed = True
                print(f"   🔄 Changement par réponse courte à {seg_start:.1f}s: '{text}'")
            
            # 3. Questions directes
            elif (pause_duration > 1.0 and
            ...
            # 4. Interruptions (segments très courts)
            elif (len(text) < 15 and 
                  pause_duration > 0.5 and 
                  pause_duration < 1.5):
                speaker_changed = True
    ...
    def process_audio(self, audio_path: str, output_path: str = None, 
        ...
        """
        Traite un fichier audio : transcription + assignation manuelle des locuteurs.
        ...
        try:
            ...
            # Étape 2: Assignation manuelle des locuteurs
            speaker_segments = self.assign_speakers_manually(result.get("segments", []))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Transcription avec identification manuelle des locuteurs",
...
Exemples d'utilisation:
  ...
  %(prog)s audio.mp3 -f srt                   # Format SRT (sous-titres)
    ...
    try:
        ...
        processor = ManualSpeakerDiarization(
